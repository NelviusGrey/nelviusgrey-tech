...
import { siteConfig, workCases, insights } from "@/lib/constants";
import { createPageMetadata } from "@/lib/seo";

export const metadata: Metadata = createPageMetadata({ title: "Ighere G. Nelson", description: "Ighere G. Nelson is Founder / Chief Innovation Technologist at NelviusGrey Tech, building practical digital, data and climate systems from Lagos, Nigeria.", path: "/authors/ighere-g-nelson", image: siteConfig.brand.founderPhoto, imageAlt: "Ighere G. Nelson" });
...
export default function AuthorPage() {
  ...
  return <>
    ...
    <PageHeader eyebrow="Author / Founder" title={siteConfig.founder.name} description="Founder / Chief Innovation Technologist working across technology product development, data systems, analytics, ClimateTech, InsurTech and social-impact information systems." />
